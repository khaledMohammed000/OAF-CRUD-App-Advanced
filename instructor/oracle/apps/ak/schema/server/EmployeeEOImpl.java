...
public class EmployeeEOImpl extends OAEntityImpl {
    ...
    public static final int EMAILADDRESS = 18;
    public static final int EMPLOYEEID = 19;
    public static final int ENDDATE = 20;
    public static final int FIRSTNAME = 21;
    public static final int FULLNAME = 22;
    public static final int LASTNAME = 23;
    ...
    public static final int MANAGERID = 27;
    public static final int MIDDLENAMES = 28;
    public static final int POSITIONCODE = 29;
    public static final int SALARY = 30;
    public static final int STARTDATE = 31;
    public static final int TITLE = 32;
    public static final int EMPLOYEEEO = 33;
    public static final int MANAGERIDEMPLOYEEEO = 34;
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        if (mDefinitionObject == null) {
            mDefinitionObject =
                    (OAEntityDefImpl)EntityDefImpl.findDefObject("instructor.oracle.apps.ak.schema.server.EmployeeEO");
        }
    ...
    public void create(AttributeList attributeList) {
        ...
        //added the set startdate for the employee here
    ...
    public void setEmployeeId(Number value) {
        ...
        if (getEmployeeId() != null) {
            throw new OAAttrValException(OAException.TYP_ENTITY_OBJECT,
                                         getEntityDef().getFullName(),
                                         getPrimaryKey(), "EmployeeId", value,
                                         "AK", "FWK_TBX_T_EMP_ID_NO_UPDATE");
        }
        if (value != null) {
        ...
        // set on the EO cache (during the scope of setAttributeInternal
    ...
    //This is the validateEndDate method
    ...
    //Adding the validateStartDate above
     ...
     */
    public RowIterator getManagerIdEmployeeEO() {
        return (RowIterator)getAttributeInternal(MANAGERIDEMPLOYEEEO);
    }
